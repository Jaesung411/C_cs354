...
{
    //check if the size of board is over 9
    if(size > 9)
    {
        return 0;
    }
    ...
    for(int i = 0; i < size; i++)
    {
        ...
        {
            //it allows the duplicate 0's
            if(*(*(board + i) + j) != 0)
            {
                for(int k = 0; k < size; k++)
                {
                    //check if no duplicate integers (1-n) in any row
                ...
                for(int k = 0; k < size; k++)
                {
                    //check if no duplicate integers (1-n) in any colunm
